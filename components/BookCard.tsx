  ...
  return (
    <div className="card group hover:scale-[1.02] transition-transform duration-300">
      <div className="flex gap-4">
        {/* Book Cover */}
        <div className="flex-shrink-0 w-24 h-36 relative bg-brown-medium/10 rounded-lg overflow-hidden">
          {image_url ? (
            <Image
              src={image_url}
              alt={title}
        ...
        <div className="flex-1 min-w-0">
          {/* Title */}
          <h3 className="font-serif text-xl font-semibold text-brown-dark mb-2 line-clamp-2">
            {title}
          </h3>
          ...
          {/* Description */}
          {description && (
            <p className="text-brown-dark/80 text-sm line-clamp-3 mb-4">
              {description}
            </p>
          )}
          ...
          <div className="flex items-center gap-3">
            {preview_link && (
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-copper text-white text-sm font-medium hover:bg-copper/90 transition-colors"
              >
                <span>Preview</span>
            ...
            >
              ...
              <span>{showPrices ? 'Hide Prices' : 'Check Prices'}</span>
            </button>

            {/* Similarity Score (for debugging/demo) */}
            {similarity_score !== undefined && (
              <span className="text-xs text-brown-medium/60">
